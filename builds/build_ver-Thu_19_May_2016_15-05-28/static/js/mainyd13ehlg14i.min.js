!function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="./static/js/",__webpack_require__(0)}([function(module,exports,__webpack_require__){"use strict";__webpack_require__(1),__webpack_require__(2)},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;/*!
...
script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/\b(?:java|ecma)script\b/},converters:{"text script":function(text){return jQuery.globalEval(text),text}}}),jQuery.ajaxPrefilter("script",function(s){void 0===s.cache&&(s.cache=!1),s.crossDomain&&(s.type="GET")}),jQuery.ajaxTransport("script",function(s){if(s.crossDomain){var script,callback;return{send:function(_,complete){script=jQuery("<script>").prop({charset:s.scriptCharset,src:s.url}).on("load error",callback=function(evt){script.remove(),callback=null,evt&&complete("error"===evt.type?404:200,evt.type)}),document.head.appendChild(script[0])},abort:function(){callback&&callback()}}}});var oldCallbacks=[],rjsonp=/(=)\?(?=&|$)|\?\?/;jQuery.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var callback=oldCallbacks.pop()||jQuery.expando+"_"+nonce++;return this[callback]=!0,callback}}),jQuery.ajaxPrefilter("json jsonp",function(s,originalSettings,jqXHR){var callbackName,overwritten,responseContainer,jsonProp=s.jsonp!==!1&&(rjsonp.test(s.url)?"url":"string"==typeof s.data&&0===(s.contentType||"").indexOf("application/x-www-form-urlencoded")&&rjsonp.test(s.data)&&"data");return jsonProp||"jsonp"===s.dataTypes[0]?(callbackName=s.jsonpCallback=jQuery.isFunction(s.jsonpCallback)?s.jsonpCallback():s.jsonpCallback,jsonProp?s[jsonProp]=s[jsonProp].replace(rjsonp,"$1"+callbackName):s.jsonp!==!1&&(s.url+=(rquery.test(s.url)?"&":"?")+s.jsonp+"="+callbackName),s.converters["script json"]=function(){return responseContainer||jQuery.error(callbackName+" was not called"),responseContainer[0]},s.dataTypes[0]="json",overwritten=window[callbackName],window[callbackName]=function(){responseContainer=arguments},jqXHR.always(function(){void 0===overwritten?jQuery(window).removeProp(callbackName):window[callbackName]=overwritten,s[callbackName]&&(s.jsonpCallback=originalSettings.jsonpCallback,oldCallbacks.push(callbackName)),responseContainer&&jQuery.isFunction(overwritten)&&overwritten(responseContainer[0]),responseContainer=overwritten=void 0}),"script"):void 0}),jQuery.parseHTML=function(data,context,keepScripts){if(!data||"string"!=typeof data)return null;"boolean"==typeof context&&(keepScripts=context,context=!1),context=context||document;var parsed=rsingleTag.exec(data),scripts=!keepScripts&&[];return parsed?[context.createElement(parsed[1])]:(parsed=buildFragment([data],context,scripts),scripts&&scripts.length&&jQuery(scripts).remove(),jQuery.merge([],parsed.childNodes))};var _load=jQuery.fn.load;jQuery.fn.load=function(url,params,callback){if("string"!=typeof url&&_load)return _load.apply(this,arguments);var selector,type,response,self=this,off=url.indexOf(" ");return off>-1&&(selector=jQuery.trim(url.slice(off)),url=url.slice(0,off)),jQuery.isFunction(params)?(callback=params,params=void 0):params&&"object"==typeof params&&(type="POST"),self.length>0&&jQuery.ajax({url:url,type:type||"GET",dataType:"html",data:params}).done(function(responseText){response=arguments,self.html(selector?jQuery("<div>").append(jQuery.parseHTML(responseText)).find(selector):responseText)}).always(callback&&function(jqXHR,status){self.each(function(){callback.apply(this,response||[jqXHR.responseText,status,jqXHR])})}),this},jQuery.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(i,type){jQuery.fn[type]=function(fn){return this.on(type,fn)}}),jQuery.expr.filters.animated=function(elem){return jQuery.grep(jQuery.timers,function(fn){return elem===fn.elem}).length},jQuery.offset={setOffset:function(elem,options,i){var curPosition,curLeft,curCSSTop,curTop,curOffset,curCSSLeft,calculatePosition,position=jQuery.css(elem,"position"),curElem=jQuery(elem),props={};"static"===position&&(elem.style.position="relative"),curOffset=curElem.offset(),curCSSTop=jQuery.css(elem,"top"),curCSSLeft=jQuery.css(elem,"left"),calculatePosition=("absolute"===position||"fixed"===position)&&(curCSSTop+curCSSLeft).indexOf("auto")>-1,calculatePosition?(curPosition=curElem.position(),curTop=curPosition.top,curLeft=curPosition.left):(curTop=parseFloat(curCSSTop)||0,curLeft=parseFloat(curCSSLeft)||0),jQuery.isFunction(options)&&(options=options.call(elem,i,jQuery.extend({},curOffset))),null!=options.top&&(props.top=options.top-curOffset.top+curTop),null!=options.left&&(props.left=options.left-curOffset.left+curLeft),"using"in options?options.using.call(elem,props):curElem.css(props)}},jQuery.fn.extend({offset:function(options){if(arguments.length)return void 0===options?this:this.each(function(i){jQuery.offset.setOffset(this,options,i)});var docElem,win,elem=this[0],box={top:0,left:0},doc=elem&&elem.ownerDocument;if(doc)return docElem=doc.documentElement,jQuery.contains(docElem,elem)?(box=elem.getBoundingClientRect(),win=getWindow(doc),{top:box.top+win.pageYOffset-docElem.clientTop,left:box.left+win.pageXOffset-docElem.clientLeft}):box},position:function(){if(this[0]){var offsetParent,offset,elem=this[0],parentOffset={top:0,left:0};return"fixed"===jQuery.css(elem,"position")?offset=elem.getBoundingClientRect():(offsetParent=this.offsetParent(),offset=this.offset(),jQuery.nodeName(offsetParent[0],"html")||(parentOffset=offsetParent.offset()),parentOffset.top+=jQuery.css(offsetParent[0],"borderTopWidth",!0),parentOffset.left+=jQuery.css(offsetParent[0],"borderLeftWidth",!0)),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent;offsetParent&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||documentElement})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top="pageYOffset"===prop;jQuery.fn[method]=function(val){return access(this,function(elem,method,val){var win=getWindow(elem);return void 0===val?win?win[prop]:elem[method]:void(win?win.scrollTo(top?win.pageXOffset:val,top?val:win.pageYOffset):elem[method]=val)},method,val,arguments.length)}}),jQuery.each(["top","left"],function(i,prop){jQuery.cssHooks[prop]=addGetHookIf(support.pixelPosition,function(elem,computed){return computed?(computed=curCSS(elem,prop),rnumnonpx.test(computed)?jQuery(elem).position()[prop]+"px":computed):void 0})}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):void 0===value?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.extend({bind:function(types,data,fn){return this.on(types,null,data,fn)},unbind:function(types,fn){return this.off(types,null,fn)},delegate:function(selector,types,data,fn){return this.on(types,selector,data,fn)},undelegate:function(selector,types,fn){return 1===arguments.length?this.off(selector,"**"):this.off(types,selector||"**",fn)},size:function(){return this.length}}),jQuery.fn.andSelf=jQuery.fn.addBack,__WEBPACK_AMD_DEFINE_ARRAY__=[],__WEBPACK_AMD_DEFINE_RESULT__=function(){return jQuery}.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__),!(void 0!==__WEBPACK_AMD_DEFINE_RESULT__&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__));var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},noGlobal||(window.jQuery=window.$=jQuery),jQuery})},function(module,exports,__webpack_require__){"use strict";function Timer(duration,container){this.duration=duration,this.$container=container,this.enabled=!1,this.pastTime=0}function Quiz(container,params){this.params=$.extend(!0,{},this.defaultParams,params),this.$container=container,this.position=0,this.totalPastedTime=0,this.results=[],this.timer=null,this.questionsArr=this.params.questions,this.quiestionsArrLenght=this.questionsArr.length,this.timerDuration=this.params.timerDuration,this.waitingTime=this.params.waitingTime,this.signatureLink=this.params.signatureLink,this.onAfterEnd=this.params.onAfterEnd||null,this.init()}var $=__webpack_require__(1);Timer.prototype.run=function(){var self=this,time=this.duration/1e3;this.enabled=!0,this.$container.text(time),this.timerId=setInterval(function(){time>0&&self.enabled===!0&&(time--,self.pastTime+=1,self.$container.text(time))},1e3)},Timer.prototype.stop=function(){clearInterval(this.timerId),this.enabled=!1},Timer.prototype.getPastedTime=function(){return this.pastTime};var questions=[{q:"../static/img/content/cola.png",a:["#96ceb4","#ffeead","#ff6f69","#ffcc5c"],c:["#ff6f69"]},{q:"../static/img/content/levis.png",a:["#96ceb4","#ffeead","#ff6f69","#ffcc5c"],c:["#ff6f69"]}];Quiz.prototype.defaultParams={timerDuration:1e4,waitingTime:3e3,signatureLink:"http://rabbi.co.il"},Quiz.prototype._printQuestions=function(){function pushResults(answer,correct){curResults.question=curQ,curResults.answer=answer,curResults.correct=correct,curResults.pastTime+=self.timer.getPastedTime(),self.results.push(curResults),self.questionsArr[self.position+1]?(self.position++,setTimeout(function(){self._printQuestions()},self.waitingTime)):(self.end=!0,setTimeout(function(){self.$container.find(".quiz__inner").fadeOut(2e3).promise().done(function(){printResults(),self.onAfterEndCallback()})},self.waitingTime))}function printResults(){self.$container.addClass("quiz-done").find(resultsContainer).html("<p>Results: "+getTotalCorrect(self.results)+"\\"+self.quiestionsArrLenght+"</p>\n             <p>Total spent time "+self.totalPastedTime+'</p>\n             <p><a href="'+self.signatureLink+'" target="_blank">'+self.signatureLink.replace(/.*?:\/\//g,"")+"</a></p>")}function getTotalCorrect(arr){for(var totalCorrect=0,i=0,len=arr.length;len>i;i++)arr[i].correct&&(totalCorrect+=1);return totalCorrect}var self=this,cur=this.questionsArr[this.position],curQ=cur.q,curA=cur.a,curC=cur.c,curResults={question:curQ,answer:null,correct:null,pastTime:0},questionsContainer=this.$container.find(".quiz__question"),answersContainer=this.$container.find(".quiz__answers"),resultsContainer=this.$container.find(".quiz__results"),timerContainer=this.$container.find(".quiz__timer");questionsContainer.html('<img src="'+curQ+'" alt="brand"/>'),this._printAnswers(answersContainer,curA),questionsContainer.removeClass("active"),this.timer=new Timer(self.timerDuration,timerContainer),this.timer.run(),$(".quiz__answers .item input").on("change",function(e){var el=$(event.target),val=event.target.value,correct=val==curC;self.totalPastedTime+=self.timer.pastTime,self.timer.stop(),answersContainer.find(".item input").prop("disabled",!0),questionsContainer.addClass("active"),correct?el.parent().addClass("correct animated flip"):(el.parent().addClass("incorrect animated shake"),answersContainer.find('input[value="'+curC+'"]').parent().addClass("correct")),pushResults(val,correct)})},Quiz.prototype._printAnswers=function(aContainer,aArr){aContainer.empty(),aArr.map(function(el,i){aContainer.append('<div class="item" style="background-color: '+el+';">\n                    <input type="radio" name="quiz" id="quiz-'+(i+1)+'" value="'+el+'">\n                    <label for="quiz-'+(i+1)+'"></label>\n            </div>')})},Quiz.prototype.onAfterEndCallback=function(){var self=this;self.onAfterEnd&&$.isFunction(self.onAfterEnd)&&self.onAfterEnd()},Quiz.prototype.restart=function(){this.results=[],this.end=!1,this.position=0,this.totalPastedTime=0,this.timer.stop(),this.$container.removeClass("quiz-done").find(".quiz__inner").fadeIn(600),this.init()},Quiz.prototype.init=function(){this._printQuestions()},$(document).ready(function(){var demo=new Quiz($(".quiz-1"),{questions:questions,onAfterEnd:function(){}});$(".quiz__restart").on("click",function(){demo.restart()})})}]);